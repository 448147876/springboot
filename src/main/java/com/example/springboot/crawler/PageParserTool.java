...
public class PageParserTool {
    ...
    /* 通过选择器来选取页面的 */
    public static Elements select(PageCrawler page , String cssSelector) {
     ...
     *
     *  */
    public static Element select(PageCrawler page , String cssSelector, int index) {
     ...
     * @return
     */
    public static  Set<String> getLinks(PageCrawler page ,String cssSelector) {
     ...
     * @return
     */
    public static ArrayList<String> getAttrs(PageCrawler page , String cssSelector, String attrName) {
