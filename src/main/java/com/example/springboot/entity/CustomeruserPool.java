...
@ApiModel(value="CustomeruserPool对象", description="")
public class CustomeruserPool implements Serializable {


    private static final long serialVersionUID = 3079075001357266353L;
